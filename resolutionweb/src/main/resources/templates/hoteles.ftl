            ...
            <div class="col-1">
                <form role="form" action="/find" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="id"  placeholder="Ejemplo: 12da0186-8033" required/>
                        <input type="text" class="form-control" name="precio"  placeholder="Ejemplo: 12da0186-8033" required/>
                        <input type="text" class="form-control" name="name"  placeholder="Ejemplo: 12da0186-8033" required/>
                        <input type="text" class="form-control" name="description"  placeholder="Ejemplo: 12da0186-8033" required/>
                        <input type="text" class="form-control" name="imgUri" id="pais"  placeholder="Ejemplo: 12da0186-8033" required/>
...
<form role="form" action="/find" method="post">
        ...
        <div class="col-9">
            ...
            <#if uu??>
                ...
                <img src="/img/7.jpg" class="card-img-left clearfix" style="float:left" alt="resultado" width="200" height="200">
                <div class="mb-2 text-primary position-relative clearfix">${uu.name}</div>
                <div class="mb-1 text-muted float-right clearfix">${uu.imgUri}</div>
                <p class="card-text mb-auto float-right clearfix">${uu.description}</p>
                <p class="card-text mb-auto float-right clearfix">${uu.id}</p>
                <h3>${uu.precio}€</h3>
                ...
                <!--Fin  Results del buscador por ID -->
            <#if item??>
                <#list item as item>
                    <div class="card flex-md-row mb-4 shadow-sm h-md-250">
                    <div class="card-body d-flex flex-column align-items-start">
                      <img src="https://avatars0.githubusercontent.com/u/32575391?s=460&v=4" class="card-img-left clearfix" style="float:left" alt="resultado" width="200" height="200">
                    <div class="mb-2 text-primary position-relative clearfix">${item.name!""}</div>
                    <div class="mb-1 text-muted float-right clearfix">${item.imgUri!""}</div>
                    <p class="card-text mb-auto float-right clearfix">${item.description!""}</p>
                    <p class="card-text mb-auto float-right clearfix">${item.id!""}</p>
                    <h3>${item.precio!""}€</h3>
                    <a href="/Update/${item.id!""}" id="id" name="id">
                    <button type="button" class="btn btn-outline-primary align-items-end clearfix">Reservar</button>
                    </a>
                        <br>
                    <button type="button" class="btn btn-outline-danger align-items-end clearfix">Eliminar</button>
                    ...
                    <div class="card-body d-flex flex-column align-items-start">
                    <img src="/img/7.jpg" class="card-img-left clearfix" style="float:left" alt="resultado" width="200" height="200">
                    <div class="mb-2 text-primary position-relative clearfix"></div>
                    <div class="mb-1 text-muted float-right clearfix"></div>
                    <p class="card-text mb-auto float-right clearfix"></p>
                    <p class="card-text mb-auto float-right clearfix"></p>
                    <h3>€</h3>
                <a href="/Update/${item.id}" id="id" name="id">
                    <button type="button" class="btn btn-outline-primary align-items-end clearfix">Reservar</button>
...
<hr>
            <div class="col-2">
            <!-- <form action="#" th:action="@{/Update/{id}}" th:object="$ {item.id}" method="post">
                ...
                <div>
                    ...
                    <div>
                        <label for="distance">pais</label>
                    </div>
                    <div>
                        <input type="text" th:field="*{imgUri}" />
                    </div>
                    <div>
